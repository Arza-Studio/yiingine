...
/**
 * This is the model class for a Permission.
 */
class Permission extends AuthorizationItem
{    
    /**
    ...
    {
        return \Yii::t(__CLASS__, '{n, plural, =1{Permission}other{Permissions}}', ['n' => $plural ? 2 : 1]);
    }
    
    /** @return integer the type of the item.*/
    public function getType()
    {
        return AuthorizationItem::PERMISSION;
    }
}
