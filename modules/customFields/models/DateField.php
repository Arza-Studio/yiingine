...
/** A model for custom fields of type DATE.*/
class DateField extends CustomField
{   
    /**
    ...
    {
        return Yii::$app->db->schema->queryBuilder->getColumnType('date').' DEFAULT "'.
               ($this->default ? $this->default: '0000-00-00').'"';
    }
}
