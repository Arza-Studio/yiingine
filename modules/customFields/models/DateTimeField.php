...
/** A model for custom fields of type DATETIME.*/
...
{    
    ...
    {
        return Yii::$app->db->schema->queryBuilder->getColumnType('datetime').' DEFAULT "'.
               ($this->default ? $this->default: '0000-00-00 00:00:00').'"';
    }
}
